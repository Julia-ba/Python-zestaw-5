...
class TestFractions(unittest.TestCase):
    ...
    def test_simplify(self):
        self.assertEqual(simplify([4, 8]), [1, 2])
        self.assertEqual(simplify([-4, -8]), [1, 2])
        self.assertEqual(simplify([-3, 15]), [-1, 5])

    def test_add_frac(self):
        self.assertEqual(add_frac([1, 2], [1, 3]), [5, 6])
        self.assertEqual(add_frac([-1, 2], [1, 2]), [0, 1])
        self.assertEqual(add_frac([2, 5], [1, 3]), [11, 15])

    def test_sub_frac(self):
        self.assertEqual(sub_frac([1, 4], [1, 2]), [-1, 4])
        self.assertEqual(sub_frac([1, 2], [5, 2]), [-2, 1])

    def test_mul_frac(self):
        self.assertEqual(mul_frac([1, 3], [3, 4]), [1, 4])
        self.assertEqual(mul_frac([-1, 4], [2, 3]), [-1, 6])
    ...
    def test_cmp_frac(self):
        ...
        self.assertEqual(cmp_frac([1, 5], [1, 2]), -1)
        self.assertEqual(cmp_frac([3, 2], [1, 1]), 1)
        self.assertEqual(cmp_frac([2, 4], [3, 6]), 0)
